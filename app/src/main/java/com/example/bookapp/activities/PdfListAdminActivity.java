...
public class PdfListAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set pdf category
        binding.pdfListSubtitleTv.setText(categoryTitle);

        loadPdfList();

        //search
        binding.pdfListSearchEt.addTextChangedListener(new TextWatcher() {
            @Override
        ...
        binding.pdfListBackIbtn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ref.orderByChild("categoryId").equalTo(categoryId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        binding.pdfListBooksRv.setAdapter(adapterPdfAdmin);
                    }
